...
typedef std::function<void(uint8_t* payload, unsigned int)> MessageReceivedCallback;
...
public:
  ...
  bool publishRaw(const String &topic, uint8_t * payload, unsigned int payload_length, bool retain = false);
