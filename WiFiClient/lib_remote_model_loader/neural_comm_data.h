struct InputGram: CommunicationData{
  float x;
  float y;
  InputGram(int id=0,int x=2,int y=3){
    this->id = id;
    this->x = x;
    this->y = y;
  }
...
struct OutputGram: CommunicationData{
  float x;
  float y;
  OutputGram(int id=1,int x=2,int y=3){
    this->id = id;
    this->x = x;
    this->y = y;
  }
...
struct WeightGram: CommunicationData{
  ...
  WeightGram(int id=2, int param_id=0, int start_loc=0, float x0=0, float x1=0, float x2=0, float x3=0, float x4=0, float x5=0, float x6=0, float x7=0)
