...
def main():
    ...
    for i in range(current_step, current_step + 400):
        single_train_run_and_log(dqn_solver, env, score_logger, i)
        print("saving")
...
def single_train_run_and_log(dqn_solver, env, score_logger, run):
    score = single_training_run(dqn_solver, env)
